...
void Piramida(float tinggi, float sisi, float red, float green, float blue)
{
    // Atas
    glPushMatrix();
...
void display() {
    ...
    Piramida(6.0f, 6.0f, 1.0f, 0.0f, 0.0f); // Contoh: piramida dengan tinggi 6 dan panjang sisi alas 6, berwarna merah
    glutSwapBuffers();
    glFlush();
}
